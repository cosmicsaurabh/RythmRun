...
export class ActivityController {
    ...
    likeActivity = async (req: Request, res: Response) => {
        try {
            ...
            const result = await this.activityService.likeActivity(req.user!.id, activityId);
    ...
    unlikeActivity = async (req: Request, res: Response) => {
        try {
            ...
            const result = await this.activityService.unlikeActivity(req.user!.id, activityId);
