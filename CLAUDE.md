# RythmRun Claude Checklist

Codex-specific guidance lives in `AGENTS.md`. Keep guidance in sync between
...
- **Never add a Claude/AI attribution or `Co-Authored-By` line** to a commit
  message or PR body.
