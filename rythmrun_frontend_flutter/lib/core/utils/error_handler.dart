...
class ErrorHandler {
  ...
  static String _parseValidationError(String errorMessage) {
    try {
        ...
        if (error is Map<String, dynamic>) {
          ...
          if (constraints != null) {
            for (final constraint in constraints.values) {
              final message = _friendlyValidationMessage(property, constraint.toString());
              final priority = _getErrorPriority(property, constraint.toString());
      ...
      final sortedMessages = errorMessages.map((e) => e['message'] as String).toList();
  ...
  static String _friendlyValidationMessage(String? property, String constraint) {
